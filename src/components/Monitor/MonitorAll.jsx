...
const MonitorAll = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        const response = await fetch(`http://localhost:5000/MonitorDetails`);
  ...
  }, [currentProduct, currentProductIndex]); // Added currentProductIndex dependency
  ...
  const goToPrevious = () => {
    ...
    console.log("Going to previous:", newIndex); // Debug log

    setCurrentProductIndex(newIndex);

    // Update URL without page reload
    if (products[newIndex]) {
      navigate(`/monitor/${products[newIndex].id}`, { replace: true });
    }
  };
  ...
  const goToNext = () => {
    ...
    console.log("Going to next:", newIndex); // Debug log
        ...
        <div className="container my-5">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-muted">Loading monitor details...</p>
            </div>
          </div>
        </div>
        <Footer />
      ...
      <>
        ...
        <div className="container my-5">
          <div className="alert alert-danger text-center">
            ...
            <a href="/AllMonitors" className="btn btn-primary">
              Back to Monitors
            </a>
          </div>
        </div>
      ...
      <div className="container my-5">
        ...
        <div className="d-flex justify-content-end align-items-center mb-4">
          <div className="d-flex align-items-center gap-3">
            <button
              className="btn btn-outline-primary btn-lg rounded-circle p-3"
              onClick={goToPrevious}
              title="Previous Monitor"
            ...
            <div className="text-center">
              <h6 className="mb-0 fw-bold">
                Monitor {currentProductIndex + 1} of {products.length}
              </h6>
              <small className="text-muted">
                Navigate through all monitors
              </small>
            </div>
            <button
              className="btn btn-outline-primary btn-lg rounded-circle p-3"
        ...
        <nav aria-label="breadcrumb" className="mb-4">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item">
              <a href="/Monitor" className="text-decoration-none">
                Monitors
              </a>
            </li>
          ...
          <div className="col-lg-6">
            <div className="mb-4">
              ...
              <div className="mt-2 text-success">
                <small>✓ In Stock • Free delivery available</small>
              </div>
            </div>
              ...
              <div className="card border-0 bg-light shadow-sm rounded-4 mb-4">
                <div className="card-body p-4">
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <ul className="list-unstyled">
                        ...
                        {currentProduct.specifications.displaySize && (
                          <li className="mb-2">
                            <strong>Display Size:</strong>{" "}
                            {currentProduct.specifications.displaySize}
                          </li>
                        )}
                        {currentProduct.specifications.resolution && (
                          <li className="mb-2">
                    ...
                    <div className="col-md-6">
                      <ul className="list-unstyled">
                        {currentProduct.specifications.panelType && (
                          <li className="mb-2">
                            <strong>Panel Type:</strong>{" "}
                            {currentProduct.specifications.panelType}
                          </li>
                        )}
                        {currentProduct.specifications.responseTime && (
                          <li className="mb-2">
                  ...
                  {currentProduct.aboutThisItem &&
                    currentProduct.aboutThisItem.length > 0 && (
                      <>
                        <h5 className="fw-semibold mt-4">About this item:</h5>
                        <ul className="list-group list-group-flush bg-transparent">
                          {currentProduct.aboutThisItem.map((item, index) => (
                            <li
                              key={index}
            ...
            <div className="d-flex gap-3 mt-4">
              <button
                ...
                onClick={() => {
                  ...
                  const cartItem = {
                    productId: `monitor_${currentProduct.id}_${
