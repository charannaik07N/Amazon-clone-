  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response = await fetch(`http://localhost:5000/lightdetails`);
      ...
      <div className="container my-5">
        ...
        <nav aria-label="breadcrumb" className="mb-4">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item">
              <a href="/Lights" className="text-decoration-none">
                Lights
              </a>
            </li>
            ...
            <div className="d-flex gap-3 mt-4">
              <button
                ...
                onClick={() => {
                  ...
                  const cartItem = {
                    productId: `light_${currentProduct.id}`,
                    name: currentProduct.name,
                    price: getCurrentPrice() / quantity, // Get unit price
                    quantity: quantity,
                    image: productImages[activeImage] || currentProduct.image,
                    category: "Lights",
