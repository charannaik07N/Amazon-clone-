...
const StandDetails = () => {
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      let colorName = "";
      if (selectedColor && currentProduct.colorOptions) {
        const colorOption = currentProduct.colorOptions.find(c => c.id === selectedColor);
        colorName = colorOption ? colorOption.name : selectedColor;
      }
      
      // Prepare cart item data
      const cartItem = {
        productId: `stand_${currentProduct.id}_${selectedColor || 'default'}`,
        name: currentProduct.name,
        price: selectedPrice,
        quantity: quantity,
        image: getProductImages()[activeImage] || currentProduct.image,
        color: colorName || '',
        size: selectedModel || '',
      ...
      <div className="container my-5">
        ...
        <nav aria-label="breadcrumb" className="mb-4">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item">
              <a href="/stand" className="text-decoration-none">
                Tables
              </a>
            </li>
