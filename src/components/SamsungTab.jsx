// components/products/SamsungProducts.js
  ...
  const samsungProducts = [
    {
      ...
      image: '/image/tab-s8.jpg',
      price: '$899',
      specs: '14.6-inch Super AMOLED display'
    },
    {
      id: 2,
      name: 'Galaxy Tab A8',
      image: '/image/tab-a8.jpg',
      price: '$229',
      specs: '10.5-inch LCD display'
    },
  ...
  return (
    <>
      ...
      <Container className="py-5">
        ...
        <h2 className="mb-4">Samsung Products</h2>
