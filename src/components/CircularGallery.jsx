...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      ...
      {
        image: `/image/Motorala.jpg`,
        text: "Motorola",
      },
      {
        image: `/image/Inifix.jpg`,
        text: "Infinix",
      },
    ];
...
export default function CircularGallery({
  ...
  useEffect(() => {
    ...
    if (welcomeMessageRef.current) {
      welcomeMessageRef.current.style.opacity = 0;
      welcomeMessageRef.current.style.transition = "opacity 1s ease-in-out";
      setTimeout(() => {
