...
const EarbudsAll = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        const response = await fetch(`http://localhost:5000/Earbudsdetails`);
  ...
  const getCurrentPrice = () => {
    if (!selectedModel || !currentProduct)
      return currentProduct?.discountedPrice || 0;
    const modelOption = currentProduct.modelOptions?.find(
      (m) => m.model === selectedModel
    );
    return modelOption
      ? modelOption.price * quantity
      : currentProduct.discountedPrice * quantity;
  };
      ...
      <>
        ...
        <div className="container my-5">
          <div className="alert alert-danger text-center">
            ...
            <a href="/Allearbuds" className="btn btn-primary">
              Back to Products
            </a>
          </div>
        </div>
      ...
      <div className="container my-5">
        ...
        <nav aria-label="breadcrumb" className="mb-4">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item">
              <a href="/audio" className="text-decoration-none">
                Audio
              </a>
            </li>
            <li className="breadcrumb-item">
              <a href="/Allearbuds" className="text-decoration-none">
                Earbuds
              </a>
            </li>
            ...
            <div className="mb-4">
              ...
              <div className="d-flex align-items-center gap-2 mb-3">
                ...
                <span className="text-muted small">
                  ...
                  {currentProduct.reviewCount?.toLocaleString() || "0"} Reviews
                </span>
              </div>
              ...
              <div className="card border-0 bg-light shadow-sm rounded-4 mb-4">
                <div className="card-body p-4">
                  ...
                  {currentProduct.aboutItem &&
                    currentProduct.aboutItem.length > 0 && (
                      <>
                        <h5 className="fw-semibold mt-4">About this item:</h5>
                        <ul className="list-group list-group-flush bg-transparent">
                          {currentProduct.aboutItem.map((item, index) => (
                            <li
                              key={index}
              ...
              <button
                ...
                onClick={() => {
                  if (currentProduct.inStock) {
                    ...
                    const cartItem = {
                      productId: `earbuds_${currentProduct.id}_${
                ...
                {currentProduct.freeDelivery && (
                  <div className="d-flex align-items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <small className="text-muted">
                        Delivery within {currentProduct.deliveryTime}
                      </small>
                    </div>
                  </div>
                )}
